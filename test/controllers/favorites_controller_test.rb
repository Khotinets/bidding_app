...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { product: @favorite.product, user: @favorite.user } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { product: @favorite.product, user: @favorite.user } }
