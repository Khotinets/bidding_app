...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { product_id: @auction.product_id, user_id: @auction.user_id } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { product_id: @auction.product_id, user_id: @auction.user_id } }
